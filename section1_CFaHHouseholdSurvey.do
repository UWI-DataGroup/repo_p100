...
preserve
    ...
    datasignature set, saving(cfah1_id1, replace)
...
label data "CFaH Survey. Dataset01-Participant Information. Pre-release1. 07Oct2018"
datasignature set, saving(cfah1_pr1, replace)
save "`datapath'/version01/2-working/section1_pre-release1.dta", replace
